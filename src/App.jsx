            ...
            <BrowserRouter>
              <Routes>
                <Route path="/">
                  ...
                  <Route path="job-single/:id" element={<JobSingleDynamic/>} />
                  

                  
                  <Route path="employers-list" element={<EmployerListPage />} />

                  <Route path="employers-single/:id" element={<EmployersSingle />} />

                  
                  <Route path="candidates-list" element={<CandidateListPage />} />

                  <Route path="candidates-single/:id" element={<CandidateSingleDynamic />} />
